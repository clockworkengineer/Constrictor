...
class MainWindow(QMainWindow, Ui_fpe_main_window):
    ...
    def __start_stop(self) -> None:
        ...
        self.__rowChanged(self.fpe_running_watchers_list.currentRow())
    ...
    def __init__(self, fpe_engine: Engine, parent=None):
        ...
        self.fpe_running_watcher_start_stop_button.clicked.connect(self.__start_stop)
