...
class Ui_fpe_main_window(object):
    def setupUi(self, fpe_main_window):
        ...
        fpe_main_window.resize(530, 285)
        ...
        fpe_main_window.setMaximumSize(QtCore.QSize(530, 285))
        ...
        self.gridLayout.addWidget(self.fpe_running_watcher_save_button, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.fpe_running_watcher_delete_button, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.fpe_running_watchers_list, 0, 0, 5, 1)
        ...
        self.gridLayout.addWidget(self.fpe_running_watcher_add_button, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.fpe_running_watcher_start_stop_button, 6, 0, 1, 1)
